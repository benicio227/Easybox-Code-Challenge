...
public class InserirProdutoValidator : AbstractValidator<InserirProdutoCommand>
{
    public InserirProdutoValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.PedidoId)
            .GreaterThan(0).WithMessage("O PedidoId é obrigatório.");
    }
}
